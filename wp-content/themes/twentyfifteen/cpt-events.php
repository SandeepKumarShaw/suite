...
$args = array(
    ...
    'menu_icon' => get_template_directory().'/images/event_16.png',
    'hierarchical' => false,
...
function tf_events_meta () {
    ...
    print_r($custom['tf_events_startdate'][0]);
    if(isset($custom['tf_events_startdate'][0])):
...
function events_styles() {
    ...
    if( 'tf_events' != $post_type )
        return;
    wp_enqueue_style('ui-datepicker', get_template_directory() . '/css/jquery-ui-1.8.9.custom.css');
}
...
function events_scripts() {
    ...
    if( 'tf_events' != $post_type )
    return;
    wp_enqueue_script('jquery-ui', get_template_directory() . '/js/jquery-ui-1.8.9.custom.min.js', array('jquery'), '', '');
    wp_enqueue_script('ui-datepicker', get_template_directory() . '/js/jquery.ui.datepicker.min.js', array('jquery'), '', '');
    wp_enqueue_script('custom_script', get_template_directory().'/js/pubforce-admin.js', array('jquery'), '', '');
}
function tf_functions_css() {
    wp_enqueue_style('tf-functions-css', get_template_directory() . '/css/tf-functions.css');
}
add_action( 'admin_enqueue_scripts', 'tf_functions_css' );

add_action( 'admin_enqueue_scripts', 'events_styles' );
